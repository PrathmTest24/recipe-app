          ...
          <div className="w-full  md:w-1/2 lg:w-1/4   px-4 mb-8">
            ...
            <div className="mt-5 max-w-60  bg-white rounded overflow-hidden shadow-lg">
              ...
              <div className="px-4  pb-2">
                ...
                {/* <button onClick={()=>handleFav({name:item.name,difficulty:item.difficulty,img:item.image})} className="ml-1 bg-black text-white px-4 py-2 rounded">Add to Favorites</button> */}
